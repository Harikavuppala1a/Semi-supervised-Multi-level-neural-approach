...
def multi_inputs(sent_cnt, word_cnt_sent, rnn_dim, att_dim, word_feats, sen_enc_feats, dropO1, dropO2, nonlin, out_vec_size, rnn_type, stack_rnn_flag, num_cnn_filters, max_pool_k_val, kernel_sizes,st_variant,use_conf_scores,multi_task_tl, share_weights_sep_mt, single_inp_tasks_list, sep_inp_tasks_list,n_fine_tune_layers,tf_hub_path, output_representation, bert_trainable):
    model, model_multi_task_or_tr, att_mod, post_vec, model_inputs, model_outputs, saved_layers = hier_fuse(sent_cnt, word_cnt_sent, rnn_dim, att_dim, word_feats, sen_enc_feats, dropO1, dropO2, nonlin, out_vec_size, single_inp_tasks_list, rnn_type, stack_rnn_flag, num_cnn_filters, max_pool_k_val, kernel_sizes,st_variant,use_conf_scores,multi_task_tl,"classi", False, [],n_fine_tune_layers,tf_hub_path, output_representation, bert_trainable)
    for sep_task_tup in sep_inp_tasks_list:
        ...
        if multi_task_tl =="tr_learn" or share_weights_sep_mt:
            aux_model, aux_model_multi_task_or_tr, aux_att_mod, aux_post_vec, aux_model_inputs,aux_model_outputs, unused_saved_layers = hier_fuse(sep_task_dict['max_num_sent'], sep_task_dict['max_words_sent'], rnn_dim, att_dim, sep_task_dict['word_feats'], sep_task_dict['sent_enc_feats'], dropO1, dropO2, sep_task_dict['nonlin'], sep_task_dict['out_vec_size'], [], rnn_type, stack_rnn_flag, num_cnn_filters, max_pool_k_val, kernel_sizes,st_variant,use_conf_scores,multi_task_tl,sep_task_name, True, saved_layers,n_fine_tune_layers,tf_hub_path, output_representation, bert_trainable)
        else:
            aux_model, aux_model_multi_task_or_tr, aux_att_mod, aux_post_vec, aux_model_inputs,aux_model_outputs, unused_saved_layers = hier_fuse(sep_task_dict['max_num_sent'], sep_task_dict['max_words_sent'], rnn_dim, att_dim, sep_task_dict['word_feats'], sep_task_dict['sent_enc_feats'], dropO1, dropO2, sep_task_dict['nonlin'], sep_task_dict['out_vec_size'], [], rnn_type, stack_rnn_flag, num_cnn_filters, max_pool_k_val, kernel_sizes,st_variant,use_conf_scores,multi_task_tl,sep_task_name, False, [],n_fine_tune_layers,tf_hub_path, output_representation, bert_trainable)
...
def get_model(m_type, word_cnt_post, sent_cnt, word_cnt_sent, word_feats, sen_enc_feats, learn_rate, dropO1, dropO2, num_cnn_filters, rnn_type, loss_func, nonlin, out_vec_size, rnn_dim, att_dim, max_pool_k_val, stack_rnn_flag, kernel_sizes,st_variant,use_conf_scores,multi_task_tl,share_weights_sep_mt, single_inp_tasks_list, sep_inp_tasks_list,compile_flag,n_fine_tune_layers,tf_hub_path, output_representation, bert_trainable):
    post_vec = None
    if m_type == 'flat_fuse':
