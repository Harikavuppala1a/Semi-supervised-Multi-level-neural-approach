                                                ...
                                                for att_dim in conf_dict["att_dims"]:
                                                    for stack_rnn_flag in conf_dict["stack_rnn_flags"]:
                                                        ...
                                                        for thresh in conf_dict["threshes"]:
                                                            startTime = time.time()
                                                            info_str = "model: %s, word_feats = %s, sent_enc_feats = %s, prob_trans_type = %s, class_imb_flag = %s, num_cnn_filters = %s, cnn_kernel_set = %s, rnn_type = %s, rnn_dim = %s, att_dim = %s, max_pool_k_val = %s, stack_rnn_flag = %s, thresh = %s, multi_task_tl = %s, share_weights_sep_mt =%s, prime filename = %s, aux filename = %s, augment data = %s, scaling_confscores = %s, scale_value = %s, beta = %s, use label corr = %s, train ratio = %s, map filename = %s, merge = %s,test mode = %s" % (model_type,word_feat_str,sent_enc_feat_str,prob_trans_type,class_imb_flag,num_cnn_filters,cnn_kernel_set,rnn_type,rnn_dim,att_dim,max_pool_k_val,stack_rnn_flag, thresh, conf_dict_com['multi_task_tl'], conf_dict_com['share_weights_sep_mt'], prime_filename, aux_str, conf_dict_com['augment_data'], conf_dict_com['scaling_confscores'], conf_dict_com['scale_value'],conf_dict_com['beta'],conf_dict_com['label_corr_setting'],conf_dict_com['train_ratio'],map_filename, conf_dict_com['merge'], conf_dict_com["test_mode"])
                                                            fname_part = ("%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s" % (model_type,word_feat_str,sent_enc_feat_str,prob_trans_type,class_imb_flag,num_cnn_filters,cnn_kernel_set_str,rnn_type,rnn_dim,att_dim,max_pool_k_val,stack_rnn_flag, conf_dict_com['multi_task_tl'],conf_dict_com['share_weights_sep_mt'], prime_filename, aux_str,conf_dict_com['augment_data'],conf_dict_com['scaling_confscores'], conf_dict_com['scale_value'],conf_dict_com['beta'],conf_dict_com['label_corr_setting'],conf_dict_com['train_ratio'],get_filename(map_filename), conf_dict_com["merge"], conf_dict_com["test_mode"]))
                                                            pred_vals_total = []
                                                            true_vals_total = []
